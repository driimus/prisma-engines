...
fn nice_error_for_unknown_generator_preview_feature() {
    ...
    let expectation = expect![[r#"
        [1;91merror[0m: [1mThe preview feature "foo" is not known. Expected one of: orderByRelation, nApi, selectRelationCount, orderByAggregateGroup, filterJson, planetScaleMode, mongoDb, interactiveTransactions, fullTextSearch[0m
